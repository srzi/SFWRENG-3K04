###########################################################################
## Makefile generated for component 'Group30_SFWR_Assignment1_SIMULINK'. 
## 
## Makefile     : Group30_SFWR_Assignment1_SIMULINK.mk
## Generated on : Thu Nov 24 17:43:44 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Group30_SFWR_Assignment1_SIMULINK.elf
...
PRODUCT_NAME              = Group30_SFWR_Assignment1_SIMULINK
MAKEFILE                  = Group30_SFWR_Assignment1_SIMULINK.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/ramu7/OneDrive/Desktop/Unistuff/3K04/PaceMaker/PaceMaker_3K04
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = Group30_SFWR_Assignment1_SIMULINK_comp.rsp
CMD_FILE                  = Group30_SFWR_Assignment1_SIMULINK.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Group30_SFWR_Assignment1_SIMULINK.elf
...
DEFINES_ = -DMW_SERIAL0_RXBUF_SIZE=16 -DMW_SERIAL0_TXBUF_SIZE=14 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__
...
DEFINES_STANDARD = -DMODEL=Group30_SFWR_Assignment1_SIMULINK -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o MW_PWM.o MW_SCI.o Group30_SFWR_Assignment1_SIMULINK.o Group30_SFWR_Assignment1_SIMULINK_data.o Transmit_DCM.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/Group30_SFWR_Assignment1_SIMULINK_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Group30_SFWR_Assignment1_SIMULINK_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Group30_SFWR_Assignment1_SIMULINK_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Group30_SFWR_Assignment1_SIMULINK_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Group30_SFWR_Assignment1_SIMULINK_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Group30_SFWR_Assignment1_SIMULINK_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Group30_SFWR_Assignment1_SIMULINK.o : $(START_DIR)/Group30_SFWR_Assignment1_SIMULINK_ert_rtw/Group30_SFWR_Assignment1_SIMULINK.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Group30_SFWR_Assignment1_SIMULINK_data.o : $(START_DIR)/Group30_SFWR_Assignment1_SIMULINK_ert_rtw/Group30_SFWR_Assignment1_SIMULINK_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Transmit_DCM.o : $(START_DIR)/Group30_SFWR_Assignment1_SIMULINK_ert_rtw/Transmit_DCM.c
	$(CC) $(CFLAGS) -o "$@" "$<"
