###########################################################################
## Makefile generated for component 'P1'. 
## 
## Makefile     : P1.mk
## Generated on : Mon Oct 17 16:40:33 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/P1.elf
...
COMPILER_COMMAND_FILE     = P1_comp.rsp
CMD_FILE                  = P1.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/P1.elf
...
OBJS = MW_digitalIO.o mw_sdk_interface.o MW_AnalogInput.o MW_PWM.o P1.o P1_data.o P1_tgtconn.o updown.o ext_work.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o k64f_rtiostream_interface.o k64f_rtiostream_commservice.o k64f_ext_svr.o k64f_rtiostream_utils.o tgtSvc_UARTInfo.o
...
%.o : $(START_DIR)/P1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/P1_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/P1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/P1_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/P1_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


P1.o : $(START_DIR)/P1_ert_rtw/P1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


P1_data.o : $(START_DIR)/P1_ert_rtw/P1_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


P1_tgtconn.o : $(START_DIR)/P1_ert_rtw/P1_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"
